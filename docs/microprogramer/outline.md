...
## Slide 10｜Nuxt Websites

### 標題

Nuxt Websites: SEO, RWD, and Performance

### 定位

這頁不是第三個完整專案介紹，而是補強我在 Nuxt 官網、SEO、RWD 與效能上的實務經驗。避免同時展開太多專案，畫面只保留 FUKUKU 作為 Nuxt 官網補充案例。
...
> 下一個階段，我希望成為什麼樣的工程師，以及微程式為什麼能幫助我朝這個方向持續成長。

### 畫面內容建議

此頁畫面需精簡，不要把所有文字都放上去。建議使用三欄或三段式時間軸呈現。
...
* 我期待在微程式持續累積產品開發經驗，也希望透過跨產業的專案，接觸不同的使用情境與需求
* 我相信不同領域的產品會帶來不同挑戰，也能幫助我建立更完整的產品思維與系統思維
* 這與我希望從前端出發，逐步理解系統架構、資料流與產品運作方式的職涯方向相當契合
